...
class Assistant(Agent):
    def __init__(self) -> None:
        super().__init__(
                instructions=(
                    """
                    You are a friendly, human-like voice assistant for Apex Capital helping customers get SME loans.
